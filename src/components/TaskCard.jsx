...
export const TaskCard = ({ task, context, currentUserId, onToggle, onDelete, onEdit }) => {
  ...
  return (
    <div className={`group flex items-start p-4 bg-white border rounded-xl mb-3 transition-all shadow-sm ${isCompleted ? 'border-gray-100 bg-gray-50/50' : 'border-gray-200 hover:border-black hover:shadow-md'}`}>
      ...
      {/* Botón de edición de tarea (dispara carga completa en formulario) */}
      <button onClick={onEdit} className="p-1.5 text-gray-300 hover:text-black transition-colors opacity-0 group-hover:opacity-100">
